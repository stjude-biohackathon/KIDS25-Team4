...
def annotateFromMitoMap(fileName):
	file = open(fileName, 'r')
...
def annotateNonSynSnpsSummary(sumFileName):
...
def addMutationAssessorAnnotations(sumFileName):
...
def annotateFromLevinEtAl(sumFileName):
        sumFile = open(sumFileName, 'r')
...
def main():
	...
	annotateFromMitoMap(filename)
	annotateFromMtDB(filename + "_annotatedMitoMapDS")
	annotateNonSynSnpsSummary(filename + "_annotatedMitoMapDS_mtDB")
	addMutationAssessorAnnotations(filename + "_annotatedMitoMapDS_mtDB_nonSyn")
	annotateFromLevinEtAl(filename + "_annotatedMitoMapDS_mtDB_nonSyn_MutationAssessor")
	finalizeFile(filename + "_annotatedMitoMapDS_mtDB_nonSyn_MutationAssessor_LevinEtAl")
	addRnaInfo(filename + "_annotatedMitoMapDS_mtDB_nonSyn_MutationAssessor_LevinEtAl_finalized.txt")
	addMMpopFreq(filename + "_annotatedMitoMapDS_mtDB_nonSyn_MutationAssessor_LevinEtAl_finalized_rnaInfo.txt")
